...
namespace Assets.Space_Shooter_Template_FREE.Scripts
{
    ...
    {
        [Range(0, 100)] [Tooltip("probability with which the ship of this wave will make a shot")]
    ...
    public class Wave : MonoBehaviour
    {
        ...
        [Tooltip("Enemy's prefab")] public GameObject enemy;

        [Tooltip("a number of enemies in the wave")]
        public int count;

        [Tooltip("path passage speed")] public float speed;
