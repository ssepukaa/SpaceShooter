...
namespace Assets.Space_Shooter_Template_FREE.Scripts
{
    ...
    public class PlayerShooting : MonoBehaviour
    {
        ...
        [Tooltip("current weapon power")] [Range(1, 4)] //change it if you wish
        ...
        {
            switch
                (weaponPower) // according to weapon power 'pooling' the defined anount of projectiles, on the defined position, in the defined rotation
            {
                case 1:
